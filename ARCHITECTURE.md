...
3. **Agent Layer (`pr_reviewer.py`)**: Formats prompt, enforces output schemas, and invokes LLM endpoint.
4. **Action**: Posts inline diff reviews or falls back to issue comments if line matching fails.